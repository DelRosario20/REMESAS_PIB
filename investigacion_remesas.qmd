...
Para profundizar en el análisis de las dinámicas de las principales variables económicas, se aplicó una transformación logarítmica a las variables de consumo, remesas, producto interno bruto, gasto público, inversión, exportaciones netas ajustadas, inflación ajustada e ingreso per cápita. La transformación logarítmica facilita analizar cambios proporcionales y suavizar la varianza, lo cual es particularmente práctico en series de tiempo económicas. Este enfoque mejora la interpretación de los efectos relativos, facilitando comparaciones y el análisis de la elasticidad en las respuestas económicas. Análisis mediante el software estadística de RStudio. 
...
Comparación de las variables de estudio y su evolución

![Gráfico de la evolución de las remesas](IMAGENES/evolucion_total.png)
...
Adicionalmente, como variables independientes consderadas se obtuvo que para el gasto público con un coeficiente de 0.2911 puntos tiene un efecto positivo, con un espaldo con un valor *"p"* significativo, indicando que el gasto del estado actua como un impulso en el crecimiento económico. Pesé que, las demas variables independienes no tienen una contribución estadística significativa en el modelo, siguen representando contribuciones positivas del comercio exterior y la inversión al Producto Interno Bruto (PIB) del Ecuador. 
