...
Los modelos de regresión escalonada en dos etapas aplicados dentro del estudio permitieron la evaluación detallada del impacto de las remesas sobre el consumo y cómo esta relación repercute signicativamente dentro del PIB de Ecuador entre 2010 y 2022. Los modelos propuestos fueron sujetos a evaluaciones de rigidez estadística para garantizar la validez de los resultados mediante pruebas de colinealidad, heterocedastidad y autocorrelación, las cuáles impulsan la validez de los modelos aplicados.
